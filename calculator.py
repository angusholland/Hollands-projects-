...
canvas1 = tk.Canvas(root, width = 370, height = 300)
canvas1.pack()
...
def mod() :
    ...
    label8 = tk.Label(root, text= float(v1)%float(v2),font=('helvetica', 10, 'bold'),bg='white')
    canvas1.create_window(210, 240, window=label8)

buttonMod = tk.Button(text='mod', command=mod, bg='green', fg='white', font=('helvetica', 9, 'bold'), width = 5)
canvas1.create_window(290, 190, window=buttonMod)
